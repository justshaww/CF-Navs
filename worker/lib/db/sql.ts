...
export const CATEGORY_LIST_SQL =
  'SELECT id, title, icon, parent_id, sort, created_at FROM categories ORDER BY sort ASC, id ASC'
...
export const PUBLIC_CATEGORY_LIST_SQL =
  'SELECT id, title, icon, parent_id, sort FROM categories ORDER BY sort ASC, id ASC'
