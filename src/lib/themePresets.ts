...
export const gradientPresets: ThemeGradientPreset[] = [
  createFlatPreset('paper-sage', '纸页鼠尾草', '暖白纸张与鼠尾草绿，安静自然。', { page: '#fdfcf9', darkPage: '#20261f', card: '#ffffff', darkCard: '#2b332a', accent: '#536b52', darkAccent: '#94b58c' }),
  createFlatPreset('paper-clay', '温暖陶土', '淡陶土与暖灰，柔和而有人情味。', { page: '#fcf9f8', darkPage: '#2a211f', card: '#ffffff', darkCard: '#372b28', accent: '#936b63', darkAccent: '#c99084' }),
  createFlatPreset('paper-wheat', '澄澈秋麦', '奶油纸色与麦穗金，温暖但不过亮。', { page: '#faf8f5', darkPage: '#29251d', card: '#ffffff', darkCard: '#373126', accent: '#896a43', darkAccent: '#cba36d' }),
  createFlatPreset('paper-slate', '静谧海岩', '清浅海岩蓝灰，适合长时间浏览。', { page: '#f5f8fa', darkPage: '#20272b', card: '#ffffff', darkCard: '#2b3439', accent: '#506f80', darkAccent: '#8eafbf' }),
  createFlatPreset('paper-pine', '森林深处', '低饱和松林绿，沉稳专注。', { page: '#f8faf6', darkPage: '#1d241c', card: '#ffffff', darkCard: '#283126', accent: '#43523f', darkAccent: '#8fa585' }),
  createFlatPreset('paper-sakura', '樱落粉黛', '克制的樱粉与暖灰，轻柔不甜腻。', { page: '#fcf7f9', darkPage: '#2b2024', card: '#ffffff', darkCard: '#382a2f', accent: '#a85f72', darkAccent: '#d88fa2' }),
  createFlatPreset('paper-lavender', '静谧薰衣', '灰紫与雾白构成的低刺激色系。', { page: '#f7f6fb', darkPage: '#25222e', card: '#ffffff', darkCard: '#312d3c', accent: '#665a9e', darkAccent: '#a59ad3' }),
  createFlatPreset('paper-indigo', '深海墨蓝', '偏灰的墨蓝强调色，清晰理性。', { page: '#f4f6f9', darkPage: '#1d222a', card: '#ffffff', darkCard: '#282f39', accent: '#425f8c', darkAccent: '#849fc8' }),
  createFlatPreset('paper-amber', '晨光琥珀', '暖白与柔和琥珀，明亮且舒适。', { page: '#faf8f3', darkPage: '#29241b', card: '#ffffff', darkCard: '#373024', accent: '#98651f', darkAccent: '#d3a75e' }),
