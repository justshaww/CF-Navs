...
- [设计文档](docs/development/DESIGN.md) - 项目设计思路和架构
- [开发状态](docs/development/PROJECT_STATUS.md) - 当前开发进度
- [待办事项](docs/development/TODO.md) - 功能清单和规划
- [修复记录](docs/development/) - 各种 bug 修复记录
